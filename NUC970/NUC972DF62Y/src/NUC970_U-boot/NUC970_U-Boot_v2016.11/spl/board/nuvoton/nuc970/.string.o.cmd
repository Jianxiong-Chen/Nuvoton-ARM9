cmd_spl/board/nuvoton/nuc970/string.o := arm-linux-gnueabihf-gcc -Wp,-MD,spl/board/nuvoton/nuc970/.string.o.d  -nostdinc -isystem /usr/local/arm/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/4.9.4/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv5te -D__LINUX_ARM_ARCH__=5    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(string)"  -D"KBUILD_MODNAME=KBUILD_STR(string)" -c -o spl/board/nuvoton/nuc970/string.o board/nuvoton/nuc970/string.c

source_spl/board/nuvoton/nuc970/string.o := board/nuvoton/nuc970/string.c

deps_spl/board/nuvoton/nuc970/string.o := \
  ...
  include/configs/nuc970_evb.h \
    ...
    $(wildcard include/config/spl/nand/load.h) \
...
spl/board/nuvoton/nuc970/string.o: $(deps_spl/board/nuvoton/nuc970/string.o)
